...
**1. Make folders for today, and copy your file into it.**
...
```{r class.source="scrolling", echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
...
Create a script that will call variants in the BAM file you made in yesterday's assignment (`20H102_S21_L002_R2_001`). You can use either program. When you are done, copy it to the folder `$turnin/day_4/`. Make sure you add your name to the file name! Try to run it on the cluster, it may take a few hours. 
