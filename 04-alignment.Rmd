...
```{cat, class.source='foldable'}
bwa mem -t 1 -M -R '@RG\tID:moch\tLB:moch\tPL:ILLUMINA\tSM:moch' $shared/reference_genome/moch.dovetail.reference.hap1.scaffolds.renamed.fasta mountain_chickadee_trimmed_1P mountain_chickadee_trimmed_2P | samtools view -q20 -b > mountain_chickadee.filtered.bam
```
