...
```{cat, class.source='foldable'}
grep -o "TAA\|TAG\|TGA" chickadee.fasta | wc -l
...
echo "Chr10_1\t3458000\t3474000" > region_of_interest.bed

# Compare it to the gff file

module load bedtools 

bedtools intersect -a $shared/reference/PO2749_Poecile_gambeli.annotation.scaf.renamed.gff -b region_of_interest.txt > overlapping_features.gff
...
bcftools view -R overlapping_features.bed ../day_6/$filename > region_of_interest.vcf
...
**Enter it's name into the [gene ontology database](https://geneontology.org/). **
...
**In the analysis summary section, change the database you are comparing against. **
